(() => {
  ...
  if (!window.__GAMBOO_PINCH_DISABLED__) {
    window.__GAMBOO_PINCH_DISABLED__ = true;
  ...
  const shell = document.querySelector("[data-gamboo-pinch-shell]");
  const sizer = document.querySelector("[data-gamboo-pinch-sizer]");
  const stage = document.querySelector("[data-gamboo-pinch-stage]");
