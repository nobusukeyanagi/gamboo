(() => {
  ...
  const STORAGE_KEY = "gamboo:bet-confirmation:v1";
  const RECEIVED_KEY = "gamboo:vote-received:v1";
  ...
  const HAMAMATSU_RACES = [
    ["1R","10:35"],["2R","11:01"],["3R","11:27"],["4R","11:53"],
    ["5R","12:21"],["6R","12:52"],["7R","13:23"],["8R","13:55"],
    ["9R","14:31"],["10R","15:09"],["11R","15:49"],["12R","16:43"]
  ];
  ...
  function initHamamatsuRaceList() {
    ...
    document.addEventListener("gamboo:race-venue-filter", (event) => {
